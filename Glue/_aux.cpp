...
// ctrl-f "min-heap" https://dl.ebooksworld.ir/books/Introduction.to.Algorithms.4th.Leiserson.Stein.Rivest.Cormen.MIT.Press.9780262046305.EBooksWorld.ir.pdf
std::array<std::tuple<int, int>, 2 * n - 1> returnPerfectBinaryTreeOnArray(std::array<int, n> A) {
    int h = ceil(log2(n));
